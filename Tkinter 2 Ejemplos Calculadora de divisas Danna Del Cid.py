...
tasas_conversión={
    ...
    'GBP': {'USD': 1.36, 'EUR': 1.14, 'JP': 147.85},
    'JPY': {'USD': 0.0091, 'EUR': 0.0077, 'GBP': 0.0068},
    }
def calcular_conversión():
    ...
    if divisa_origen != divisa_destino:
        tasa=tasas_conversión[divisa_origen][divisa_destino]
...
divisas = list(tasas_conversión.keys())
...
boton_convertir=tk.Button(ventana, text="Convertir", command=calcular_conversión)
